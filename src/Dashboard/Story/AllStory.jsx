...
function AllStory() {
    ...
    const fetchStories = async () => {
      try {
        const response = await axios.get(
          "https://birthday-gift-express.vercel.app/api/v1/storey"
        );
  ...
  const deleteStory = async (id) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(
            `https://birthday-gift-express.vercel.app/api/v1/storey/${id}`
          );
  ...
  const updateStory = async () => {
    try {
      await axios.patch(
        `https://birthday-gift-express.vercel.app/api/v1/storey/${currentStory.id}`,
