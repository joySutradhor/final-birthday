...
function VideoAlbum() {
    ...
    const fetchVideos = async () => {
        try {
            const response = await axios.get('https://birthday-gift-server.vercel.app/api/v1/video');
    ...
    const deleteVideo = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await axios.delete(`https://birthday-gift-server.vercel.app/api/v1/video/${id}`);
    ...
    const onSubmit = async (data) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                try {
                    await axios.post('https://birthday-gift-server.vercel.app/api/v1/video/create', videoData);
