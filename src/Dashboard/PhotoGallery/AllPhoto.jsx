...
export default function AllPhoto() {
    ...
    useEffect(() => {
        axios
            .get("https://birthday-gift-server.vercel.app/api/v1/gallery")
    ...
    const deleteBanner = async (id) => {
        try {
            await axios.delete(`https://birthday-gift-server.vercel.app/api/v1/gallery/${id}`);
    ...
    const updateBanner = async () => {
        try {
            ...
            const response = await axios.patch(
                `https://birthday-gift-server.vercel.app/api/v1/gallery/${selectedImage.id}`,
                {
                    title: updatedTitle,
                    img: imageUrl,
                    url: updatedUrl
